...
lazy_static! {
    ...
    pub static ref TX_POOL_INSERT_TIMER: AdvancedTimer =
        register_adv_timer_with_group("timer", "tx_pool::insert_new_tx");
    pub static ref TX_POOL_VERIFY_TIMER: AdvancedTimer =
...
pub mod pool_inner_metrics {
    use metrics::{
        register_adv_timer_with_group, register_meter_with_group,
        AdvancedTimer, Counter, CounterUsize, Meter,
    };
    use std::sync::Arc;

    lazy_static! {
        pub static ref TX_POOL_RECALCULATE: AdvancedTimer =
            register_adv_timer_with_group("timer", "tx_pool::recalculate");
        pub static ref TX_POOL_INNER_INSERT_TIMER: AdvancedTimer =
            register_adv_timer_with_group("timer", "tx_pool::inner_insert");
        pub static ref DEFERRED_POOL_INNER_INSERT: AdvancedTimer =
        ...
        pub static ref TX_POOL_INNER_WITHOUTCHECK_INSERT_TIMER: AdvancedTimer =
            register_adv_timer_with_group(
                "timer",
